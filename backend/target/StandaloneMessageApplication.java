...
public class StandaloneMessageApplication {
    ...
    private static final String DB_URL = "jdbc:sqlserver://LAPTOP-0M4DC4I9:1433;DatabaseName=resume_message;encrypt=false;trustServerCertificate=true;";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.err.println("4. sa账号已启用并设置了密码123456");
            System.err.println("5. sa账号有访问resume_message数据库的权限");
            System.err.println("");
    ...
    private static void initDatabase() throws Exception {
        ...
        try {
            ...
            throw new Exception("SQL Server身份验证失败: " + e.getMessage() + 
                              "\n请确保:\n" +
                              "1. SQL Server已启用SQL Server身份验证\n" +
                              "2. sa账号已启用并设置了密码123456\n" +
                              "3. sa账号有访问resume_message数据库的权限\n" +
                              "4. SQL Server允许TCP/IP连接");
        }
    }
